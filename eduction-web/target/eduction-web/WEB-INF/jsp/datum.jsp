...
<div class="header">
    ...
    <div class="header_title">
        <ul class="header_title_ul">
            ...
            <li><a href="datum" class="header_a header_active">资料</a></li>
...
<div style="width: 100%;overflow: hidden">
    <div class="con">
        <div style="width: 100%;overflow: hidden;margin-top: 20px;">
            <img src="images/20171012131712.jpg" style="width: 100%;border-radius:4px;">
        </div>
        <table class="table table-condensed table-hover nr">
            ...
            <tr>
                ...
                <td class="ms">
                    <button type="button" class="btn btn-link">浏览</button>
            ...
            <tr>
                ...
                <td class="ms">2017-08-29 14:00:00</td>
                <td class="ms">
                    <button type="button" class="btn btn-link" style="font-size: 14px;">浏览</button>
                    <button type="button" class="btn btn-link" style="font-size: 14px;">下载</button>
                </td>
            </tr>
            </tbody>
        </table>
